...
# 双编码器-双解码器 Res-UNet
class DualEncoderDualDecoderResUNet(nn.Module):
    ...
    def forward(self, captimgs1, captimgs2, *args, **kwargs):
        b_sz, c_sz, h_sz, w_sz = captimgs1.shape  # 输入形状，例如 [4, 3, 256, 256]
...
model = DualEncoderDualDecoderResUNet()
input_tensor1 = torch.randn(4, 3, 256, 256)
input_tensor2 = torch.randn(4, 3, 256, 256)
